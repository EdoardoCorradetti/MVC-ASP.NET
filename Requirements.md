Create an ASP.NET MVC (.NET Framework) project in C# for software development that allows the data visualization and management of one of the museums of the Torino Musei Foundation.
